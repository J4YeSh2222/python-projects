...
class cafe_management():
    def Total_Bill(self):
        self.tea_price = 10
        self.coffee_price = 30
        self.sandwich_price = 50
        self.cake_price = 100
        self.burger_price = 60
        ...
        if self.sandwich_item.get() != "":
            self.sandwich_cost = self.sandwich_price * int(
                self.sandwich_item.get())
        else:
        ...
        if self.fries_item.get() != "":
            ...
            self.fries_cost = 0
        if self.shake_item.get() != "":
            self.shake_cost = self.shake_price * int(self.shake_item.get())
        else:
            self.shake_cost = 0

        self.Total_Bill = self.burger_cost + self.cake_cost + self.coffee_cost + self.fries_cost + self.pizza_cost + self.tea_cost + self.shake_cost
        ...
        if self.sub_cost != "":
            ...
            self.sub_cost.insert(
                END,
                int(self.items_cost.get()) + float(self.service_cost.get()))
        else:
            self.sub_cost.insert(
                END,
                int(self.items_cost.get()) + float(self.service_cost.get()))
        ...
        if self.total_bill != "":
            ...
            self.total_bill.insert(
                END,
                float(self.sub_cost.get()) + float(self.paid_tax.get()))
        else:
            self.total_bill.insert(
                END,
                float(self.sub_cost.get()) + float(self.paid_tax.get()))
    ...
    def equal(self):
        ...
        elif self.result.get()[0] == "0" or self.result.get(
        )[0] == "+" or self.result.get()[0] == "*" or self.result.get(
        )[0] == "/":
            self.result.delete(0, "end")
            self.result.insert("end", "error")
    ...
    def __init__(self):
        ...
        self.frame1 = LabelFrame(self.root,
                                 text="Cafe Items",
                                 width=150,
                                 height=200,
                                 font=('verdana', 10, 'bold'),
        ...
        self.tea = Label(self.frame1,
                         text="Tea",
                         font=('verdana', 10, 'bold'),
                         bg="white")
        self.tea.place(x=3, y=1)
        self.tea_item = Entry(self.frame1,
                              width=7,
                              borderwidth=4,
                              relief=SUNKEN,
                              bg="#248aa2")
        ...
        self.coffee = Label(self.frame1,
                            text="Coffee",
                            font=('verdana', 10, 'bold'),
                            bg="white")
        self.coffee.place(x=3, y=20)
        self.coffee_item = Entry(self.frame1,
                                 width=7,
                                 borderwidth=4,
                                 relief=SUNKEN,
                                 bg="#248aa2")
        ...
        self.sandwich = Label(self.frame1,
                              text="Sandwich",
                              font=('verdana', 10, 'bold'),
                              bg="white")
        self.sandwich.place(x=3, y=40)
        self.sandwich_item = Entry(self.frame1,
                                   width=7,
                                   borderwidth=4,
                                   relief=SUNKEN,
                                   bg="#248aa2")
        ...
        self.cake = Label(self.frame1,
                          text="Cake",
                          font=('verdana', 10, 'bold'),
                          bg="white")
        self.cake.place(x=3, y=60)
        self.cake_item = Entry(self.frame1,
                               width=7,
                               borderwidth=4,
                               relief=SUNKEN,
                               bg="#248aa2")
        ...
        self.burger = Label(self.frame1,
                            text="Burger",
                            font=('verdana', 10, 'bold'),
                            bg="white")
        self.burger.place(x=3, y=80)
        self.burger_item = Entry(self.frame1,
                                 width=7,
                                 borderwidth=4,
                                 relief=SUNKEN,
                                 bg="#248aa2")
        ...
        self.pizza = Label(self.frame1,
                           text="Pizza",
                           font=('verdana', 10, 'bold'),
                           bg="white")
        self.pizza.place(x=3, y=100)
        self.pizza_item = Entry(self.frame1,
                                width=7,
                                borderwidth=4,
                                relief=SUNKEN,
                                bg="#248aa2")
        ...
        self.fries = Label(self.frame1,
                           text="Fries",
                           font=('verdana', 10, 'bold'),
                           bg="white")
        self.fries.place(x=3, y=120)
        self.fries_item = Entry(self.frame1,
                                width=7,
                                borderwidth=4,
                                relief=SUNKEN,
                                bg="#248aa2")
        ...
        self.shake = Label(self.frame1,
                           text="Shake",
                           font=('verdana', 10, 'bold'),
                           bg="white")
        self.shake.place(x=3, y=140)
        self.shake_item = Entry(self.frame1,
                                width=7,
                                borderwidth=4,
                                relief=SUNKEN,
                                bg="#248aa2")
        self.shake_item.place(y=140, x=85)

        # Items Bill
        self.frame2 = LabelFrame(self.root,
                                 text="Cafe Items Bill",
                                 width=180,
                                 height=160,
                                 font=('verdana', 10, 'bold'),
                                 borderwidth=3,
        ...
        self.item_cost_lb = Label(self.frame2,
                                  text="Items Cost",
                                  font=('verdana', 10, 'bold'),
                                  bg="white")
        self.item_cost_lb.place(x=3, y=1)
        self.items_cost = Entry(self.frame2,
                                width=9,
                                borderwidth=4,
                                relief=SUNKEN,
                                bg="#248aa2")
        ...
        self.service_cost_lb = Label(self.frame2,
                                     text="Service Cost",
                                     font=('verdana', 10, 'bold'),
                                     bg="white")
        self.service_cost_lb.place(x=3, y=20)
        self.service_cost = Entry(self.frame2,
                                  width=9,
                                  borderwidth=4,
                                  relief=SUNKEN,
                                  bg="#248aa2")
        self.items_cost.place(y=20, x=100)

        self.sub_cost_lb = Label(self.frame2,
                                 text="Sub Cost",
                                 font=('verdana', 10, 'bold'),
                                 bg="white")
        self.sub_cost_lb.place(x=3, y=40)
        self.sub_cost = Entry(self.frame2,
                              width=9,
                              borderwidth=4,
                              relief=SUNKEN,
                              bg="#248aa2")
        ...
        self.paid_tax_lb = Label(self.frame2,
                                 text="Paid Tax",
                                 font=('verdana', 10, 'bold'),
                                 bg="white")
        self.paid_tax_lb.place(x=3, y=80)
        self.paid_tax = Entry(self.frame2,
                              width=9,
                              borderwidth=4,
                              relief=SUNKEN,
                              bg="#248aa2")
        ...
        self.total_bill_lb = Label(self.frame2,
                                   text="Total Bill",
                                   font=('verdana', 10, 'bold'),
                                   bg="white")
        self.total_bill_lb.place(x=3, y=100)
        self.total_bill = Entry(self.frame2,
                                width=9,
                                borderwidth=4,
                                relief=SUNKEN,
                                bg="#248aa2")
        ...
        self.result = Entry(self.frame3,
                            width=19,
                            relief=SUNKEN,
                            borderwidth=3)
        self.result.place(x=2, y=0)

        self.nine = Button(self.frame3,
                           text="9",
                           padx=6,
                           relief=RAISED,
                           borderwidth=2,
        ...
        self.multiply = Button(self.frame3,
                               text="*",
                               padx=6,
                               relief=RAISED,
                               borderwidth=2,
        ...
        self.divide = Button(self.frame3,
                             text="9",
                             padx=6,
                             relief=RAISED,
                             borderwidth=2,
        ...
        self.Total_Bills_btn = Button(self.root,
                                      text="Total",
                                      relief=RAISED,
                                      borderwidth=2,
                                      font=('verdana', 10, 'bold'),
